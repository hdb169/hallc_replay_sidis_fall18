...
void hcal_calib(string Prefix, int nstop=-1, int nstart=0) {
 ...
 double gLoThr = gmean - 3.*gsigma;
 double gHiThr = gmean + 3.*gsigma;
 ...
 Canvas->cd(4);gPad->SetLogz();gPad->SetGridx();
