...
void THcShowerCalib::Init() {
  ...
  gROOT->Reset();
  char* fname = Form("/lustre/expphy/volatile/hallc/spring17/hdbhatt/group/ROOTfiles/shcal_param_frominput_file/%s.root",fPrefix.c_str());
  // char* fname = Form("/lustre/expphy/volatile/hallc/spring17/hdbhatt/group/ROOTfiles/pcal_final/%s.root",fPrefix.c_str());
