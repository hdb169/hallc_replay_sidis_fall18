...
void THcPShowerCalib::ReadThresholds() {
  ...
  //cout << "  Heavy Gas Cerenkov min = " << fHGCerMin << endl;//=====================================================>nov7
...
void THcPShowerCalib::Init() {
  ...
  char* fname = Form("/lustre/expphy/volatile/hallc/spring17/hdbhatt/group/ROOTfiles/defocused_spring/%s.root",fPrefix.c_str());
...
bool THcPShowerCalib::ReadShRawTrack(THcPShTrack &trk, UInt_t ientry) {
  ...
  if (!good_trk) return 0;
    ...
    // bool good_hgcer = P_hgcer_npeSum >= fHGCerMin  ;//==============================================>Nov6
