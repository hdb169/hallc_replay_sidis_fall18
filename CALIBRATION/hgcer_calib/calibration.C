...
void calibration::SlaveBegin(TTree * /*tree*/)
{
  ...
  fTim1 = new TH1F("Timing_PMT1", "ADC TDC Diff PMT1 ; Time (ns) ;Counts", 200, -10.0, 80.0);
  GetOutputList()->Add(fTim1);
  fTim1_full = new TH1F("Timing_full_PMT1", "ADC TDC Diff PMT1 ; Time (ns) ;Counts", 200, -10.0, 80.0);
  GetOutputList()->Add(fTim1_full);
  fTim2 = new TH1F("Timing_PMT2", "ADC TDC Diff PMT2 ; Time (ns) ;Counts", 200, -10.0, 80.0);
  GetOutputList()->Add(fTim2);
  fTim2_full = new TH1F("Timing_full_PMT2", "ADC TDC Diff PMT1 ; Time (ns) ;Counts", 200, -10.0, 80.0);
  GetOutputList()->Add(fTim2_full);
  fTim3 = new TH1F("Timing_PMT3", "ADC TDC Diff PMT3 ; Time (ns) ;Counts", 200, -10.0, 80.0);
  GetOutputList()->Add(fTim3);
  fTim3_full = new TH1F("Timing_full_PMT3", "ADC TDC Diff PMT1 ; Time (ns) ;Counts", 200, -10.0, 80.0);
  GetOutputList()->Add(fTim3_full);
  fTim4 = new TH1F("Timing_PMT4", "ADC TDC Diff PMT4 ; Time (ns) ;Counts", 200, -10.0, 80.0);
  GetOutputList()->Add(fTim4);
  fTim4_full = new TH1F("Timing_full_PMT4", "ADC TDC Diff PMT1 ; Time (ns) ;Counts", 200, -10.0, 80.0);
