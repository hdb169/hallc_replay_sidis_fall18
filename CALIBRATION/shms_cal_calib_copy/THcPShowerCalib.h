...
class THcPShowerCalib {
 ...
 private:
  ...
  // Double_t fNGCerMin;              // Threshold noble gas Cerenkov signal, p.e.------------------------------------->oct 4
  ...
  // TBranch* b_P_ngcer_npeSum;----------------------------------->oct 4
  TBranch* b_P_tr_beta;
...
void THcPShowerCalib::ReadThresholds() {
  ...
  // cout << "  Noble Gas Cerenkov min = " << fNGCerMin << endl;----------------------oct 4
...
void THcPShowerCalib::Init() {
  ...
  //fTree->SetBranchAddress("P.ngcer.npeSum", &P_ngcer_npeSum,&b_P_ngcer_npeSum);----------------------------oct 4
...
bool THcPShowerCalib::ReadShRawTrack(THcPShTrack &trk, UInt_t ientry) {
  ...
  //    bool good_ngcer = P_ngcer_npeSum >= fNGCerMin ; //oct 04, 19
