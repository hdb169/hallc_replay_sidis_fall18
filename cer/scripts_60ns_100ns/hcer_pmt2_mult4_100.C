void hcer_pmt2_mult4_100(){
  ...
  TH1F *h1 = new TH1F("h1","Time Pmt2 Old Mult4 100ns", 300, 40, 160);
  TH2F *h2 = new TH2F("h2","Amp vs Time Pmt2 Old Mult4 100ns", 300, 40, 160, 620, -20, 1000); 
  TH1F *h3 = new TH1F("h3","Time Pmt2 New Mult4 100ns", 300, 40, 160);
  TH2F *h4 = new TH2F("h4","Amp vs Time Pmt2 New Mult4 100ns", 300, 40, 160, 620, -20, 1000);
  ...
  c1->SaveAs("pdf/hcer_pmt2_mult4_100.pdf");
