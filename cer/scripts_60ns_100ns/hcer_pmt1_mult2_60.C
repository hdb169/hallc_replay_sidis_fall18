void hcer_pmt1_mult2_60(){
  ...
  TH1F *h1 = new TH1F("h1","Time Pmt1 Old Mult2 55ns", 175, 70, 140);
  TH2F *h2 = new TH2F("h2","Amp vs Time Pmt1 Old Mult2 55ns", 175, 70, 140, 620, -20, 1000); 
  TH1F *h3 = new TH1F("h3","Time Pmt1 New Mult2 55ns", 175, 70, 140);
  TH2F *h4 = new TH2F("h4","Amp vs Time Pmt1 New Mult2 55ns", 175, 70, 140, 620, -20, 1000);
  ...
  c1->SaveAs("pdf/hcer_pmt1_mult2_55.pdf");
