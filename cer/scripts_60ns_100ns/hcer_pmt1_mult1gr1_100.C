void hcer_pmt1_mult1gr1_100(){
  ...
  TH1F *h1 = new TH1F("h1","Time Pmt1 Old Mult1 or More 100ns", 300, 40, 160);
  TH2F *h2 = new TH2F("h2","Amp vs Time Pmt1 Old Mult1 or More  100ns", 300, 40, 160, 620, -20, 1000); 
  TH1F *h3 = new TH1F("h3","Time Pmt1 New Mult1 or More 100ns", 300, 40, 160);
  TH2F *h4 = new TH2F("h4","Amp vs Time Pmt1 New Mult1 or More 100ns", 300, 40, 160, 620, -20, 1000);
  ...
  c1->cd(2);gPad->SetLogz();gPad->SetLogy();gPad->SetGrid();
  h2->Draw("colz");
  ...
  c1->cd(4);gPad->SetLogz();gPad->SetLogy();gPad->SetGrid();
  h4->Draw("colz");
  ...
  c1->SaveAs("pdf/hcer_pmt1_mult1gr1_100.pdf");
