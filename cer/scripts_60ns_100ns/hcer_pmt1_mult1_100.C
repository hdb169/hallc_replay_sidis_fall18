void hcer_pmt1_mult1_100(){
  ...
  TH1F *h1 = new TH1F("h1","Time Pmt1 Old Mult1 100ns", 300, 40, 60);
  TH2F *h2 = new TH2F("h2","Amp vs Time Pmt1 Old Mult1 100ns", 300, 40, 60, 620, -20, 1000); 
  TH1F *h3 = new TH1F("h3","Time Pmt1 New Mult1 100ns", 300, 40, 60);
  TH2F *h4 = new TH2F("h4","Amp vs Time Pmt1 New Mult1 100ns", 300, 40, 60, 620, -20, 1000);


  t1->Draw("H.cer.goodAdcTdcDiffTime[0]>>h1","H.cer.goodAdcMult[0]==1");
  t1->Draw("H.cer.goodAdcPulseAmp[0]:H.cer.goodAdcTdcDiffTime[0]>>h2","H.cer.goodAdcMult[0]==1");

  t2->Draw("H.cer.goodAdcTdcDiffTime[0]>>h3","H.cer.goodAdcMult[0]==1");
  t2->Draw("H.cer.goodAdcPulseAmp[0]:H.cer.goodAdcTdcDiffTime[0]>>h4","H.cer.goodAdcMult[0]==1");
  ...
  c1->SaveAs("pdf/hcer_pmt1_mult1_100.pdf");
