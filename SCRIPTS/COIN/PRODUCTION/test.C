...
//1void replay_production_coin_hElec_pProt (Int_t RunNumber = 0, Int_t MaxEvent = 0, Double_t param =0) {
  ...
  const char* ROOTFileNamePattern = "ROOTfiles/hcal_param_frominput_file/coin_replay_production_%d_%d.root";
  //2const char* ROOTFileNamePattern = "ROOTfiles/hcal_param_frominput_file/coin_replay_production_%d_%d_param_%.3f.root";
  ...
  //3TString ROOTFileName = Form(ROOTFileNamePattern, RunNumber, MaxEvent, param);
